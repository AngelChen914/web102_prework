...
const unfundedSum = GAMES_JSON.reduce( (sum, game) => {
...
const displayStr = `A total of $${totalRaised.toLocaleString()} has been raised for 11 games. Currently, ${unfundedSum} ${unfundedSum === 1 ? "game remains unfunded" : "games remain unfunded"}. We need your help to fund these amazing games!`;
